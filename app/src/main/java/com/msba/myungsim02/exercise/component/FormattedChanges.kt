package  com.msba.myungsim02.exercise.component
...
import com.msba.myungsim02.exercise.data.dateTimeWithOffsetOrDefault
...
fun FormattedUpsertionChange(change: UpsertionChange) {
    when (change.record) {
        ...
        is DistanceRecord -> {
            ...
            Log.w("crkim", "Unknown record type: ${change.record}")
        }
    }
}
