 ...
 */
public class FragmentCP3 extends Fragment {
    ...
    public static FragmentCP3 newInstance(String param1, String param2) {
        FragmentCP3 fragment = new FragmentCP3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageView1.setImage(ImageSource.resource(R.drawable.cpet3));
