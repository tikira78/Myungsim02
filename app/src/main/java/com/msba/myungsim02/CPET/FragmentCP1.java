 ...
 */
public class FragmentCP1 extends Fragment {
    ...
    public static FragmentCP1 newInstance(String param1, String param2) {
        FragmentCP1 fragment = new FragmentCP1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageView1.setImage(ImageSource.resource(R.drawable.cpet1));
