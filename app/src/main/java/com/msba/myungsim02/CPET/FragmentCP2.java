 ...
 */
public class FragmentCP2 extends Fragment {
    ...
    public static FragmentCP2 newInstance(String param1, String param2) {
        FragmentCP2 fragment = new FragmentCP2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageView1.setImage(ImageSource.resource(R.drawable.cpet2));
