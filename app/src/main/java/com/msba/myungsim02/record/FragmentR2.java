...
import com.msba.myungsim02.record.bp.ViewAdapterSbp;
...
public class FragmentR2 extends Fragment {
    ...
    public static FragmentR1 newInstance() {
        return new FragmentR1();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //Adapter
        pagerAdapter = new ViewAdapterDbp(getActivity(), num_page);
