...
import com.msba.myungsim02.info.day.ViewAdapterDay;
 ...
 * Use the {@link FragmentI4#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentI4 extends Fragment {
    ...
    public static FragmentI2 newInstance() {
        return new FragmentI2();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri videoUri = Uri.parse("https://tikira78.github.io/creduguide/cr_day.mp4");
        ...
        //Adapter
        pagerAdapter = new ViewAdapterDay(getActivity(), num_page);
