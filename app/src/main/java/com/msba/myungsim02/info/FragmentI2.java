...
import com.msba.myungsim02.info.cr.ViewAdapterCr;
...
public class FragmentI2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri videoUri = Uri.parse("https://tikira78.github.io/creduguide/cr_program.mp4");
        ...
        //Adapter
        pagerAdapter = new ViewAdapterEx(getActivity(), num_page);
        ...
        mPager.setOffscreenPageLimit(12); //최대 이미지 수
