...
public class FragmentR5 extends Fragment {
    ...
    public static FragmentR5 newInstance(String param1, String param2) {
        FragmentR5 fragment = new FragmentR5();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageView1.setImage(ImageSource.resource(R.drawable.rk6));
