...
public class FragmentI1 extends Fragment {
    ...
    public static FragmentI1 newInstance() {
        return new FragmentI1();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       Uri videoUri = Uri.parse("https://tikira78.github.io/creduguide/cr_edu1.mp4");
        ...
        //Adapter
        pagerAdapter = new ViewAdapterCr(getActivity(), num_page);
