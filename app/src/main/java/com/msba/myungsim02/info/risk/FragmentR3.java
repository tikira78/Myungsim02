...
public class FragmentR3 extends Fragment {
    ...
    public static FragmentR3 newInstance(String param1, String param2) {
        FragmentR3 fragment = new FragmentR3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageView1.setImage(ImageSource.resource(R.drawable.rk4));
